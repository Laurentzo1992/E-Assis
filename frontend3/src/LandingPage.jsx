...
export default function LandingPage() {
  return (
    <>
      <Navbar />
      <h1 className="titleColor text-center mt-5">Notre mission</h1>
      <main className="my-3">
        <section className="mb-5 sectionColor1 text-white fw-bold position-relative container-fluid">
          ...
          {/* SVG Triangle en bas à gauche */}
          {/* <svg
            className="mission-triangle"
            viewBox="0 0 2155 1280"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
              d="M1907.48 1278C713.723 1256.39 332.265 902.897 0.5 0.5V1278H1907.48Z"
              fill="#D9D9D9"
            />
            <path
              d="M0.5 0.5C354.189 962.53 764.355 1300.71 2155 1278H1907.48M0.5 0.5V1278H1907.48M0.5 0.5C332.265 902.897 713.723 1256.39 1907.48 1278"
              stroke="black"
            />
          </svg> */}
        </section>
        ...
        <section className="mb-5 text-center sectionColor2">
          <div className="container-fluid">
            <h1 className="titleColor2 text-center ">Notre vision</h1>
        ...
        <h1 className="titleColor text-center mt-5 fs-2 mb-5">
          Pourquoi choisir notre solution ?
        </h1>

        <section className="mb-5 features-section">
          <div className="container-fluid">
            <div className="row mt-4 justify-content-center">
              ...
              <div className="col-lg-4 col-md-6 mb-4">
                <div className="feature-card">
                  ...
                  <p className="feature-description">
                    Visualisez les tendances, suivez les résultats, recevez des
                    alertes en temps réel et prenez des décisions basées sur les
                    données.
                  </p>
                </div>
              </div>
        ...
        <section className="text-center sectionColor3 ">
          <h1 className="section3-h1">
            Rejoignez les entreprises qui gagnent des marchés
          </h1>
          <button className="btn startFreeBtn mt-3 my-3">
            <Link
              to="/Inscription"
              className="connexion-signup-link ms-1 text-white text-decoration-none"
            >
