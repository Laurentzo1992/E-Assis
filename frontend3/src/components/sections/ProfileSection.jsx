...
const ProfileSection = ({
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      showCustomAlert(`Erreur lors de la suppression : ${error.message}`, "danger");
    } finally {
    ...
    <div style={{ padding: '20px' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '20px' }}>
        ...
        <div style={{ flex: '1 1 35%', display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          >
            ...
            <p>
              La suppression de <strong>{activeCompany.nom}</strong> est une action définitive et irréversible.
            </p>
            <Button
              variant="danger"
              className="w-100"
      ...
      {showDeleteConfirm && (
        ...
        >
          ...
          >
            <h3 style={{ marginBottom: '15px', color: '#dc3545' }}>Confirmer la suppression</h3>
            <p>
              Êtes-vous sûr de vouloir supprimer définitivement l'entreprise <strong>{activeCompany.nom}</strong> ?
            </p>
            <div
              style={{
            ...
            >
              Attention : cette action est irréversible et entraînera la suppression de toutes les données associées.
            </div>
