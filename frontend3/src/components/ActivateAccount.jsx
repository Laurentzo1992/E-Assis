...
export default function ActivateAccount() {
  ...
  useEffect(() => {
    fetch(`http://127.0.0.1:8000/api/auth/activate/${token}/`)
      .then(async (res) => {
        ...
        if (res.ok) {
          ...
          if (data.error && data.error.includes("Activé")) {
            ...
            setMessage(
              data.error || "Le lien d'activation est invalide ou expiré."
            );
          }
        }
      })
    ...
    <div className="d-flex align-items-center justify-content-center p-4 custom-bg">
      <div className="container text-center">
        <div className="custom-card p-4 p-sm-5">
          <h2 className="h2 fw-bold text-primary-custom mb-3">
