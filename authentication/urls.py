...
from .views import RegisterView, LoginView, ProfileView, GoogleLoginAPIView, EmailVerifyView, ChangePasswordView, ResetPasswordRequestView, ResetPasswordConfirmView
