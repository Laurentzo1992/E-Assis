...
# ================================
# 📬 EMAIL CONFIG POUR LA DÉMO
# ================================

# ❌ Ancienne config Gmail (désactivée pour la présentation locale)
...
# ✅ Nouvelle config — mails simulés dans la console (aucune erreur, aucune dépendance Internet)
